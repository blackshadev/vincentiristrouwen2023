...
export default function PresentSection({ url, className }: { url: string; className?: string }) {
  return (
    <section className={classNames(className, "grid grid-cols-1 gap-x-6 md:grid-cols-12")}>
      ...
      <div className="md:col-start-9 md:col-span-4 flex flex-row align-center justify-center">
